...
class Creeper( Monster ):           
        def __init__(self, xpos, ypos):
            self.CreeperPic = pygame.image.load('monsterGen/creeper.jpg')
...
class Zombie( Monster ):           
        def __init__(self, xpos, ypos):
            self.ZombiePic = pygame.image.load('monsterGen/zombie.jpg')
...
class Spider( Monster ):           
        def __init__(self, xpos, ypos):
            self.SpiderPic = pygame.image.load('monsterGen/spiders.jpg')
...
class Skeleton( Monster ):           
        def __init__(self, xpos, ypos):
            self.SkeletonPic = pygame.image.load('monsterGen/skeleton.jpg')
